# scale-down EFLK
kubectl scale statefulset elasticsearch-master -n monitoring --replicas=0
...
kubectl scale deployment argocd-server argocd-repo-server argocd-dex-server argocd-redis argocd-applicationset-controller argocd-notifications-controller -n argocd --replicas=1
