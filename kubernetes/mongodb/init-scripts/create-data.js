...
try{
    ...
    db.reservations.insertOne({ reservation_id: 1, full_name: "John Smite", email_address: "JohnSmite@domain.com", checkIn_date: new Date("2026-06-02"), checkOut_date: new Date("2026-06-10"), hotel_id: 1 });
    print('Data initialized successfully!');
}
catch(e) {
    print('Data already initialized, skipping: ' + e.message);
}
